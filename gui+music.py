...
def mainwindow():
    ...
    global profile_bg,chgpwd_btn,back_btn,confirm_btn,chgpwd_bg,confirm_chgpwd,nusic_bg,second_act_bg
    ...
    pre_page_btn = PhotoImage(file="img/element/pre_page_btn.png")
    next_page_btn = PhotoImage(file="img/element/next_page_btn.png")
    dis_pre_page_btn = PhotoImage(file="img/element/dis_pre_page_btn.png")
    dis_next_page_btn = PhotoImage(file="img/element/dis_next_page_btn.png")
    second_act_bg = PhotoImage(file="img/bg/second_act_bg.png")
    login_page(root)
    #root.mainloop()
